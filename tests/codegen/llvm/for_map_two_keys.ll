...
@AT_x = dso_local global %"struct map_internal_repr_t.570" zeroinitializer, section ".maps", !dbg !30
@ringbuf = dso_local global %"struct map_internal_repr_t.571" zeroinitializer, section ".maps", !dbg !44
...
for_body:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %"$kv", ptr align 1 %"$kv", i64 3, i1 false)
