...
@AT_y = dso_local global %"struct map_internal_repr_t.570" zeroinitializer, section ".maps", !dbg !22
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.571" zeroinitializer, section ".maps", !dbg !24
@stack_scratch = dso_local global %"struct map_internal_repr_t.572" zeroinitializer, section ".maps", !dbg !48
@ringbuf = dso_local global %"struct map_internal_repr_t.573" zeroinitializer, section ".maps", !dbg !60
