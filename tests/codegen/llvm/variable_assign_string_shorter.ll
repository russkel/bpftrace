...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %"$var", ptr align 1 %1, i64 6, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %"$var", ptr align 1 %"$var", i64 6, i1 false)
