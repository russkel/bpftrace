...
@ringbuf = dso_local global %"struct map_internal_repr_t.570" zeroinitializer, section ".maps", !dbg !29
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %inet, ptr align 1 %inet, i64 24, i1 false)
